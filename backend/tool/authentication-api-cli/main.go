...
import (
	...
	"github.com/lvikstro/ltime/backend/client"
	"github.com/lvikstro/ltime/backend/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "Authentication API-cli",
		Short: `CLI client for the Authentication API service`,
	}
	...
	c.UserAgent = "Authentication API-cli/0"
